import { TProductId, IProduct } from "../product/product.model";

const data: Record<TProductId, IProduct> = {
  "2zd33b8c": {
    ...
    price: 1.15,
    image:
      "https://drive.google.com/uc?export=view&id=15q9zQEAHDzcEt48_Dw62x5ufUA0ESHzV",
    attributes: {
      description:
  ...
  "6trfgkkj": {
    ...
    price: 1.21,
    image:
      "https://drive.google.com/uc?export=view&id=1rKObxziHhra4e-WheLT_5i7bhMHJcBxp",
    attributes: {
      description:
  ...
  "7bcr49em": {
    ...
    price: 1.25,
    image:
      "https://drive.google.com/uc?export=view&id=1W_lw-uPtlgkcFrvom90dIcQLP2hkPdHL",
    attributes: {
      description:
  ...
  "098323ks": {
    ...
    price: 1.51,
    image:
      "https://drive.google.com/uc?export=view&id=16T5oEltKVCRiGBoklrRSaGzBLh8eC9zX",
    attributes: {
      description:
  ...
  b8uthe2y: {
    ...
    price: 1.39,
    image:
      "https://drive.google.com/uc?export=view&id=1YU3QpsOmECjlq1IEn3deFkFVTKheZBUz",
    attributes: {
      description:
  ...
  ewxsd6xb: {
    ...
    price: 1.34,
    image:
      "https://drive.google.com/uc?export=view&id=1wFks2bg_qSjIuH_LaVrn__A0WK47tC_6",
    attributes: {
      description:
  ...
  fpr72m9k: {
    ...
    price: 1.27,
    image:
      "https://drive.google.com/uc?export=view&id=11zNkgTrAEpMMF8DUhDFjzgqJv1GhRccw",
    attributes: {
      description:
  ...
  t9dv25gs: {
    ...
    price: 1.18,
    image:
      "https://drive.google.com/uc?export=view&id=1zT5S8MOg9_ebyipAUXhPNzY5uE7ubvQc",
    attributes: {
      description:
  ...
  t345w48y: {
    ...
    price: 1.25,
    image:
      "https://drive.google.com/uc?export=view&id=1PHIL4mZOa8iCE1peCaDgcKnahmzyR8ZI",
    attributes: {
      description:
